...
# code for implementing copyedit list creation for stuff we cant auto manage yet
module dubious
  # TO DO
...
# We pass the entire site here and process pages, as this stuff is very different from the rules checking
  ...
  #     input sentence (for easy copy paste into whitelist, as well as context)
  #     output sentence (if there is a replacement value given)
  #     the summary of how to fix
  #     a blank line
  # 
  # 
  def main(sitename)
  end unless RULES_CONFIG[:dubious] #if this is what we are still using to treat the flags
    # or maybe we just catch it where we call this 
  # TODO
  # Remove all template, and <blockquote></blockquote> sections.
  # As homophones get loaded, their replace is left null, and the suggestion is always: 'Homophones: Ensure the correct word form is used.'' 
  Prepositions.prepositioncheck(page)
end
